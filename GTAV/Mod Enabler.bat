...
move ScriptHookV.dll _DisabledMods > nul 2> nul

rem ScriptHookVDotNet
move ScriptHookVDotNet.dll _DisabledMods > nul 2> nul
move ScriptHookVDotNet.ini _DisabledMods > nul 2> nul
move ScriptHookVDotNet2.dll _DisabledMods > nul 2> nul
move ScriptHookVDotNet2.xml _DisabledMods > nul 2> nul
move ScriptHookVDotNet3.dll _DisabledMods > nul 2> nul
move ScriptHookVDotNet3.xml _DisabledMods > nul 2> nul

rem OtherScriptsDLL
move ikpMP3.dll _DisabledMods > nul 2> nul

rem GTALua
move lua.dll _DisabledMods > nul 2> nul
move luabind.dll _DisabledMods > nul 2> nul

rem DrDaxxy's FOV mod
move dsound.dll _DisabledMods > nul 2> nul
move fov-log.txt _DisabledMods > nul 2> nul

rem Menyoo
move menyooLog.txt _DisabledMods > nul 2> nul
...
rem We're using robocopy to move all .exe files, apart from GTA5.exe, GTAVLauncher.exe and PlayGTAV.exe
robocopy *.exe . _DisabledMods /xf GTA5.exe GTAVLauncher.exe PlayGTAV.exe GTAVLanguageSelect.exe /mov > nul 2> nul
...
attrib +h "mods"
move menyooStuff _DisabledMods > nul 2> nul
